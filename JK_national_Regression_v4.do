...
eststo clear
estpost sum public_use dist_to_attack slope_med elev_med dist_to_road ltype_1_1 farmland_perhousehold ///
if sido_nm!="경상남도"&sido_nm!="경상북도"&sido_nm!="제주도"&dist_to_attack<=65
esttab using desc_stats_v4.tex,replace /// 
...
reg public_use dist_to_attack slope_med elev_med dist_to_road ///
...
areg public_use dist_to_attack slope_med elev_med dist_to_road ///
...
esttab m1 m2 m3 m4 using table_3_v4.tex,replace keep(dist_to_attack) b p ///
